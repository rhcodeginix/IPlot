      ...
      <div className="sticky top-[86px] bg-[#F9F5FF] rounded-[12px]">
        ...
        <div className="p-4 laptop:px-6 laptop:py-5 h-auto max-h-[600px] overflow-y-auto overFlowYAuto overflow-x-hidden">
          ...
          >
            ...
            <div>
              <button
                className={`p-1.5 lg:p-[10px] cursor-pointer flex justify-center items-center bg-greenBtn rounded-[40px] gap-[10px] transition-all duration-300 ease-out h-[32px] w-[32px] lg:h-[40px] lg:w-[40px]`}
              >
                <Image
                  src={Ic_search}
                  alt="search"
