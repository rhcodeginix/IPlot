        ...
        <SideSpaceContainer>
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-2 md:gap-3 lg:gap-4 mb-6 lg:mb-[40px]">
            <h3 className="text-darkBlack text-lg md:text-xl lg:text-2xl desktop:leading-[44.8px]">
              ...
              <span className="font-bold text-blue">{kommune} Kommune</span>
            </h3>
            {!isLoading && (
        ...
        >
          <SideSpaceContainer>
            <div className="flex justify-end items-center gap-6">
              <Button
                text="Tilbake"
                className="border-2 border-[#6941C6] bg-white text-[#6941C6] hover:border-[#7A5AF8] hover:text-[#7A5AF8] focus:border-[#5925DC] focus:text-[#5925DC] sm:text-base rounded-[40px] w-max h-[36px] md:h-[40px] lg:h-[48px] font-semibold desktop:px-[20px] relative desktop:py-[16px]"
                path="/"
              />
            </div>
          </SideSpaceContainer>
